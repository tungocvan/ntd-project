<div class="bg-white p-3 rounded-2xl shadow-xl w-full max-w-md border border-gray-100">
    ...
    <div class="mb-6 flex items-center justify-center gap-4 text-left">
        ...
        {{-- LOGO --}}
        <div class="shrink-0">
            <img src="{{ asset('storage/admission/img/logo-ntd.png') }}" class="w-20 h-20 object-contain"
                alt="Logo Trường">
        </div>
        ...
        <div>
            ...
            <h1 class="text-xs font-semibold text-gray-600 uppercase tracking-wide">
            ...
            <div class="mt-2 h-px bg-gradient-to-r from-transparent via-gray-300 to-transparent"></div>
